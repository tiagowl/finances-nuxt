declare global {
  ...
  const categorySchema: typeof import('../../server/utils/validation').categorySchema
  ...
  const getUserFromEvent: typeof import('../../server/utils/jwt').getUserFromEvent
  ...
  const occasionalTransactionSchema: typeof import('../../server/utils/validation').occasionalTransactionSchema
  ...
  const requireAuth: typeof import('../../server/utils/jwt').requireAuth
  ...
  const transactionSchema: typeof import('../../server/utils/validation').transactionSchema
  ...
  const verifyAccessToken: typeof import('../../server/utils/jwt').verifyAccessToken
  const verifyRefreshToken: typeof import('../../server/utils/jwt').verifyRefreshToken
  const wishlistSchema: typeof import('../../server/utils/validation').wishlistSchema
...
declare global {
  ...
  // @ts-ignore
  export type { JWTPayload, RefreshPayload } from '../../server/utils/jwt'
  import('../../server/utils/jwt')
  // @ts-ignore
  export type { RegisterInput, LoginInput, CategoryInput, TransactionInput, OccasionalTransactionInput, WishlistInput } from '../../server/utils/validation'
...
export { buildAssetsURL as __buildAssetsURL, publicAssetsURL as __publicAssetsURL } from 'D:/Tiago/Área de Trabalho/Projetos/finances-nuxt/src/frontend/node_modules/@nuxt/nitro-server/dist/runtime/utils/paths';
export { defineAppConfig } from 'D:/Tiago/Área de Trabalho/Projetos/finances-nuxt/src/frontend/node_modules/@nuxt/nitro-server/dist/runtime/utils/config';
export { signAccessToken, signRefreshToken, verifyAccessToken, verifyRefreshToken, getUserFromEvent, requireAuth } from 'D:/Tiago/Área de Trabalho/Projetos/finances-nuxt/src/frontend/server/utils/jwt';
export { hashPassword, comparePassword } from 'D:/Tiago/Área de Trabalho/Projetos/finances-nuxt/src/frontend/server/utils/password';
export { default as prisma } from 'D:/Tiago/Área de Trabalho/Projetos/finances-nuxt/src/frontend/server/utils/prisma';
export { registerSchema, loginSchema, categorySchema, transactionSchema, occasionalTransactionSchema, wishlistSchema } from 'D:/Tiago/Área de Trabalho/Projetos/finances-nuxt/src/frontend/server/utils/validation';